...
But first, I'll need more priorities for that. A-J will work, I think:
#+begin_src emacs-lisp
(setq org-priority-highest ?A)
(setq org-priority-lowest (+ ?A 9))
#+end_src

Also, effort estimation. I couldn't find a way to use this for now, but I'll keep it:
#+begin_src emacs-lisp
(with-eval-after-load 'org
  (add-to-list
...
***** View backlog
Tasks without deadlines are backlog.
