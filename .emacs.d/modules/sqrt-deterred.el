...
(use-package deterred
  ...
  (setq deterred-wakatime-api-key (my/password-store-get "Service/wakatime"))
  ...
  (setq deterred-read-it-later-readeck-token
        (my/password-store-get-field "Selfhosting/Accounts/readeck.sqrtminusone.xyz" "deterred_api_token"))
  ...
  (setq deterred-read-it-later-wallabag-client-id
        (my/password-store-get-field "Selfhosting/Archive/wallabag.sqrtminusone.xyz" "client_id"))
  (setq deterred-read-it-later-wallabag-client-secret
        (my/password-store-get-field "Selfhosting/Archive/wallabag.sqrtminusone.xyz" "client_secret"))
  (setq deterred-read-it-later-wallabag-username
        (my/password-store-get-field "Selfhosting/Archive/wallabag.sqrtminusone.xyz" "username"))
  (setq deterred-read-it-later-wallabag-password
        (my/password-store-get "Selfhosting/Archive/wallabag.sqrtminusone.xyz"))
