...
(pcase my/env
  ("normal" (require 'sqrt-performance) (require 'sqrt-micromamba)
   ...
   (require 'sqrt-maintenance) (require 'sqrt-general-ui)
   (require 'sqrt-doom-modeline) (require 'sqrt-perspective)
   (require 'sqrt-treemacs) (require 'sqrt-lsp)
   (require 'sqrt-flycheck) (require 'sqrt-tree-sitter)
   (require 'sqrt-reformatter) (require 'sqrt-web)
   (require 'sqrt-latex) (require 'sqrt-markup) (require 'sqrt-lisp)
   (require 'sqrt-misc-programming) (require 'sqrt-db-programming)
   ...
   (require 'sqrt-telega) (require 'sqrt-rocket) (require 'sqrt-docs)
   (require 'sqrt-ai) (require 'sqrt-index) (require 'sqrt-deterred)
   (require 'sqrt-pass) (require 'sqrt-docker)
   (require 'sqrt-misc-apps) (require 'sqrt-guix)
   (require 'sqrt-productivity-apps) (require 'sqrt-chess)
   (require 'sqrt-gource))
  ("termux" (require 'sqrt-performance) (require 'sqrt-misc-initial)
   ...
   (require 'sqrt-telega) (require 'sqrt-rocket) (require 'sqrt-docs)
   (require 'sqrt-index) (require 'sqrt-pass)
   (require 'sqrt-misc-apps) (require 'sqrt-emacs-pinentry)
