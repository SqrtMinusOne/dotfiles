...
(pcase my/env
  ("normal" (require 'sqrt-performance) (require 'sqrt-micromamba)
   ...
   (require 'sqrt-db-programming) (require 'sqrt-general-org)
   (require 'sqrt-org-literate) (require 'sqrt-org-productivity)
   (require 'sqrt-org-export) (require 'sqrt-dired)
   (require 'sqrt-tramp) (require 'sqrt-terms)
