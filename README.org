...
- Emacs packages that I wrote (so far, all of them originated in my Emacs config):
  - [[https://github.com/SqrtMinusOne/lyrics-fetcher.el][lyrics-fetcher.el]], [[https://github.com/SqrtMinusOne/pomm.el][pomm.el]], [[https://github.com/SqrtMinusOne/perspective-exwm.el][perspective-exwm.el]], [[https://github.com/SqrtMinusOne/exwm-modeline][exwm-modeline.el]]
